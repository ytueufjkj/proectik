...
static constexpr auto qt_meta_stringdata_CLASSEllipseENDCLASS = QtMocHelpers::stringData(
    "Ellipse",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSEllipseENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSEllipseENDCLASS_t qt_meta_stringdata_CLASSEllipseENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7),  // "Ellipse"
        QT_MOC_LITERAL(8, 22),  // "on_lineEdit_textEdited"
        QT_MOC_LITERAL(31, 0),  // ""
        QT_MOC_LITERAL(32, 4),  // "arg1"
        QT_MOC_LITERAL(37, 24)   // "on_lineEdit_2_textEdited"
    },
    "Ellipse",
    "on_lineEdit_textEdited",
    "",
...
Q_CONSTINIT const QMetaObject Ellipse::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSEllipseENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Ellipse, std::true_type>,
